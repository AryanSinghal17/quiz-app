...
`;
    ...
    function showQuestions() {
      ...
      if (question.questionType === "mcq") {
        ...
        const inpurElement = document.createElement("input");
        inpurElement.type =
        ...
        submitButton.onclick = () => {
          if (!answerSelected) {
            answerSelected = true;
            checkAnswer(
              inpurElement.value.toString(),
              question.answer.toString(),
            );
          }
        };
        optionsElement.appendChild(inpurElement);
        optionsElement.appendChild(submitButton);
      }

      function checkAnswer(userAns, questionAnswer) {
        const feedbackElement = document.createElement("div");

        feedbackElement.id = "feedback";

        if (
          userAns === questionAnswer ||
          userAns.toLowerCase() === questionAnswer.toLowerCase()
        ) {
          score++;
          feedbackElement.textContent = "Correct!";
          feedbackElement.style.color = "green";
        } else {
          feedbackElement.textContent = `Wrong answer , Correct Anwer${questionAnswer}`;
